...
public class Menu
{
    ...
    public static void principal2( )
    {
        ...
        System.out.println( "4.- Vázquez Roja Consola");
        System.out.println( "5.- Vázquez Rojas Ventana");
        System.out.println( "6.- Hernandez Sierra Consola");
        System.out.println( "7.- Hernandez Sierra Ventana");
